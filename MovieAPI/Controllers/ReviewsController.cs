...
namespace MovieAPI.Controllers
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public async Task<ActionResult<IEnumerable<ReviewDto>>> GetMovieReviews(int movieId)
        {
            ...
            .Select(m => new ReviewDto
            (m.ReviewerName, m.Comment, m.Rating)).ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,ReviewerName,Comment,Rating,MovieId")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ReviewerName,Comment,Rating,MovieId")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
